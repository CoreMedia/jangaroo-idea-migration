...
class FlexMigrationUtil {
  ...
  private static Set<MigrationUsageInfo> findRefs(final Project project,
    ...
    final Set<MigrationUsageInfo> results = new HashSet<>();
  ...
  static Collection<PsiElement> findJSQualifiedNamedElements(Project project, final String qName) {
    ...
    JSClassResolver classResolver = getActionScriptClassResolver();
  ...
  @NotNull
  static JSClassResolver getActionScriptClassResolver() {
